...
from storm_wiki.modules.storm_dataclass import StormArticle, StormInformationTable
...
class STORMWikiRunner(Engine):
    ...
    def run(
        ...
        if do_generate_outline:
            print(f"==> run_outline_generation_module: {topic}")
        ...
        if do_generate_article:
            print(f"==> run_article_generation_module: {topic}")
            if information_table is None:
                information_table = self._load_information_table_from_local_fs(
                    os.path.join(self.article_output_dir, "conversation_log.json")
                )
        ...
        if do_polish_article:
            print(f"==> run_article_polishing_module: {topic}")
